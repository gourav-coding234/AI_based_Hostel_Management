      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        <div className="flex flex-col items-start justify-between gap-8 rounded-3xl border border-white/10 bg-navy-900 p-8 sm:flex-row sm:items-center sm:p-10">
          ...
          <a
            href="/brochure.pdf"
            download
            className="inline-flex shrink-0 items-center gap-2 rounded-full bg-teal-500 px-7 py-3 text-sm font-semibold text-navy-950 shadow-soft transition-colors hover:bg-teal-400"
          >
